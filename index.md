...
author_profile: true
title: " "
description: Marin Lauber
excerpt: <p style="color:rgba(255, 255, 255, 0.877)">Big whorls have little whorls that feed on their velocity,<br>
          And little whorls have lesser whorls and so on to viscosity.</p>
mode: immersive
article_header:
  type: overlay
  theme: dark
  background_image:
    ...
    actions:
    - label: "Download"
      url: "https://github.com/marinlauber/2D-Turbulence-Python"
---
